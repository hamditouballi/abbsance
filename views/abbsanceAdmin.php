...
<script type="text/javascript">
  ...
  <body>
    ...
    <section class="home">
    <header style="background-image: url('../views/css/back.png');  height:120px;  background-size: cover; text-align: center; padding: 20px;">
...
<img src="../views/css/305219633_540712911186499_9137420916457086341_n.jpg" alt="">
  ...
  <button type="submit" class="btn btn-outline-success mt-2" name="all">عرض كل الغياب</button>
</form>
        <br>
        <table id="myTable_test" class="display " style="color: var(--text-color);">
          ...
          <tbody>
                  ...
                  <tr>
                            ...
                            <td><?php echo $v["Entrée_matin"]; ?></td>
                            <td><?php echo $v["Sortie_matin"]; ?></td>
                            <td><?php echo $v["Entrée_soir"]; ?></td>
                            <td><?php echo $v["Sortie_soir"]; ?></td>
                            <td>
